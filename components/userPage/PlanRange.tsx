const PlanRange = ({workouts}: {workouts: any[]}) => {
    ...
    // в range, кстати, еще показывай план что ли, насколько не успеваем или вперед идем. А выходить за range можно? лучше бы даа, интересно же ж.. 
    // отдельные очки за это давать, такие получше
